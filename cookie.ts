...
// react-router 等库使用 named import { parse }，会触发 SyntaxError。
...
export function parse(str: string, options?: CookieOptions): Record<string, string> {
...
export function serialize(name: string, val: string, options?: CookieOptions): string {
